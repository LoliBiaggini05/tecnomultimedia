...
class aventura {
  ...
  mimet( o, x, y, ea, ed) {
    if (this.opcion[o].apretobt(x, y) && this.estado== ea ) {
      this.estado=ed;
    }
  }
  andabt() {
    this.mimet(8, 470, 500, 13, 0);
    this.mimet(0, 370, 500, 0, 1);
    this.mimet(1, 170, 500, 0, 13);
    this.mimet(2, 150, 200, 1, 2);
    this.mimet(3, 120, 280, 1, 7);
    this.mimet(4, 470, 500, 2, 3);
    this.mimet(4, 470, 500, 4, 5);
    this.mimet(7, 200, 500, 7, 2);
    if (this.opcion[4].apretobt(470, 500) && this.estado== 5 ) {
      this.estado=6;
